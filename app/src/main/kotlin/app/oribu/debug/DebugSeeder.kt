 ...
 * Só é chamado (ver OribuApp) quando BuildConfig.DEBUG é true, e só insere dados se a
...
object DebugSeeder {
    ...
    private fun games(): List<MediaItem> =
        listOf(
            MediaItem(
                type = MediaType.GAME,
                title = "Elden Ring",
                status = MediaStatus.FINISHED,
                console = GameConsole.STEAM,
                rating = 5.0,
                favorite = true,
                playedMinutes = 5820,
                genre = "RPG, Ação",
                developer = "FromSoftware",
                coverUrl = cover("elden-ring"),
            ...
            MediaItem(
                ...
                coverUrl = cover("hollow-knight"),
                addedDate = offsetDays(300),
                completionDate = offsetDays(250),
            ),
            MediaItem(
                type = MediaType.GAME,
                title = "God of War Ragnarök",
                status = MediaStatus.PLATINUM,
                console = GameConsole.PS5,
                rating = 5.0,
                favorite = true,
                goldTrophies = 8,
                silverTrophies = 14,
                ...
                coverUrl = cover("gow-ragnarok"),
                addedDate = offsetDays(150),
                completionDate = offsetDays(80),
            ...
            MediaItem(
                ...
                coverUrl = cover("tlou2"),
                addedDate = offsetDays(400),
                completionDate = offsetDays(370),
            ),
            MediaItem(
                type = MediaType.GAME,
                title = "Animal Crossing: New Horizons",
                status = MediaStatus.PLAYING,
                console = GameConsole.NS,
                rating = 4.5,
                playedMinutes = 9000,
                genre = "Simulação",
                developer = "Nintendo",
                coverUrl = cover("acnh"),
                addedDate = offsetDays(600),
            ),
            MediaItem(
                type = MediaType.GAME,
                title = "The Legend of Zelda: TOTK",
                status = MediaStatus.REPLAYING,
                console = GameConsole.NS,
                rating = 5.0,
                favorite = true,
                playedMinutes = 4200,
            ...
            MediaItem(
                ...
                status = MediaStatus.COMPLETED,
                console = GameConsole.PC,
                rating = 4.5,
                playedMinutes = 12000,
                genre = "Simulação, Indie",
                developer = "ConcernedApe",
                coverUrl = cover("stardew"),
                addedDate = offsetDays(800),
                completionDate = offsetDays(700),
            ),
            MediaItem(
                type = MediaType.GAME,
                title = "Hades",
                ...
                coverUrl = cover("hades"),
                addedDate = offsetDays(250),
                completionDate = offsetDays(200),
            ),
            MediaItem(
                type = MediaType.GAME,
                ...
                coverUrl = cover("cyberpunk"),
                addedDate = offsetDays(10),
            ),
            MediaItem(
                type = MediaType.GAME,
                ...
                developer = "Atlus",
                coverUrl = cover("p5r"),
                addedDate = offsetDays(5),
            ),
        )

    private fun movies(): List<MediaItem> =
        listOf(
            MediaItem(
                ...
                coverUrl = cover("dune2"),
                addedDate = offsetDays(60),
                completionDate = offsetDays(58),
                releaseDate = offsetDays(150),
            ...
            MediaItem(
                ...
                coverUrl = cover("oppenheimer"),
                addedDate = offsetDays(200),
                completionDate = offsetDays(195),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                ...
                genre = "Comédia, Drama",
                coverUrl = cover("poor-things"),
                addedDate = offsetDays(100),
                completionDate = offsetDays(95),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                title = "Interestelar",
                ...
                genre = "Ficção Científica",
                coverUrl = cover("interstellar"),
                addedDate = offsetDays(900),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                ...
                genre = "Animação",
                coverUrl = cover("inside-out-2"),
                addedDate = offsetDays(20),
                completionDate = offsetDays(18),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                ...
                status = MediaStatus.QUEUED,
                genre = "Drama, Crime",
                coverUrl = cover("joker2"),
                addedDate = offsetDays(3),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                ...
                status = MediaStatus.QUEUED,
                genre = "Ação, Comédia",
                coverUrl = cover("deadpool3"),
                addedDate = offsetDays(7),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                title = "Beetlejuice Beetlejuice",
                status = MediaStatus.WAITING_RELEASE,
                genre = "Comédia, Fantasia",
                coverUrl = cover("beetlejuice2"),
                addedDate = offsetDays(15),
            ...
            MediaItem(
                ...
                status = MediaStatus.WATCHED,
                rating = 4.5,
                streamingPlatform = "Mubi",
                genre = "Terror",
                coverUrl = cover("the-substance"),
                addedDate = offsetDays(40),
                completionDate = offsetDays(38),
            ),
            MediaItem(
                type = MediaType.MOVIE,
                ...
                streamingPlatform = "Netflix",
                genre = "Romance, Drama",
                coverUrl = cover("past-lives"),
                addedDate = offsetDays(300),
                completionDate = offsetDays(295),
            ),
        )

    private fun seriesList(): List<MediaItem> =
        listOf(
            MediaItem(
            ...
            MediaItem(
                ...
                currentProgress = 9,
                totalProgress = 9,
                coverUrl = cover("arcane"),
                addedDate = offsetDays(500),
                completionDate = offsetDays(480),
            ),
            MediaItem(
                type = MediaType.SERIES,
                title = "Round 6",
                status = MediaStatus.WAITING_EPISODES,
                rating = 4.0,
                streamingPlatform = "Netflix",
                genre = "Drama, Suspense",
                currentProgress = 9,
                totalProgress = 9,
                coverUrl = cover("squid-game"),
            ...
            MediaItem(
                ...
                currentProgress = 10,
                totalProgress = 10,
                coverUrl = cover("shogun"),
                addedDate = offsetDays(90),
                completionDate = offsetDays(70),
            ),
            MediaItem(
                type = MediaType.SERIES,
                title = "Fallout",
                ...
                currentProgress = 5,
                totalProgress = 8,
                coverUrl = cover("fallout"),
                addedDate = offsetDays(50),
            ),
            MediaItem(
                type = MediaType.SERIES,
            ...
            MediaItem(
                ...
                currentProgress = 30,
                totalProgress = 62,
                coverUrl = cover("breaking-bad"),
                addedDate = offsetDays(1200),
            ),
            MediaItem(
                type = MediaType.SERIES,
                title = "Wandinha",
                ...
                coverUrl = cover("wednesday"),
                addedDate = offsetDays(4),
            ),
            MediaItem(
                type = MediaType.SERIES,
                title = "Slow Horses",
                status = MediaStatus.QUEUED,
                genre = "Espionagem, Drama",
                coverUrl = cover("slow-horses"),
                addedDate = offsetDays(2),
            ),
            MediaItem(
                type = MediaType.SERIES,
                title = "Loki",
                ...
                coverUrl = cover("loki"),
                addedDate = offsetDays(600),
                completionDate = offsetDays(560),
            ),
        )

    private fun mangas(): List<MediaItem> =
        listOf(
            MediaItem(
                ...
                coverUrl = cover("jjk"),
                addedDate = offsetDays(400),
                readingStartDate = offsetDays(390),
            ...
            MediaItem(
                ...
                coverUrl = cover("csm"),
                addedDate = offsetDays(200),
                readingStartDate = offsetDays(195),
            ),
            MediaItem(
                type = MediaType.MANGA,
                title = "Vagabond",
                ...
                rating = 5.0,
                genre = "Ação, Histórico",
                currentProgress = 180,
                totalProgress = 327,
                coverUrl = cover("vagabond"),
                addedDate = offsetDays(900),
                readingStartDate = offsetDays(880),
            ),
            MediaItem(
                type = MediaType.MANGA,
                title = "Vinland Saga",
                ...
                currentProgress = 210,
                totalProgress = 210,
                coverUrl = cover("vinland-saga"),
                addedDate = offsetDays(600),
                readingStartDate = offsetDays(590),
                completionDate = offsetDays(550),
            ),
            MediaItem(
                type = MediaType.MANGA,
                title = "Berserk",
                status = MediaStatus.REREADING,
                rating = 5.0,
                favorite = true,
                genre = "Ação, Fantasia Sombria",
                currentProgress = 60,
                totalProgress = 374,
                coverUrl = cover("berserk"),
                addedDate = offsetDays(1500),
                readingStartDate = offsetDays(30),
            ),
            MediaItem(
                type = MediaType.MANGA,
                title = "One Piece",
                ...
                rating = 5.0,
                genre = "Aventura, Ação",
                currentProgress = 1100,
                totalProgress = 1120,
                coverUrl = cover("one-piece"),
                addedDate = offsetDays(2000),
                readingStartDate = offsetDays(1980),
            ),
            MediaItem(
                type = MediaType.MANGA,
                title = "Solo Leveling",
                ...
                addedDate = offsetDays(300),
                readingStartDate = offsetDays(295),
                completionDate = offsetDays(260),
            ),
            MediaItem(
                ...
                coverUrl = cover("orv"),
                addedDate = offsetDays(150),
                readingStartDate = offsetDays(145),
            ),
            MediaItem(
                type = MediaType.WEBTOON,
                title = "Tower of God",
                ...
                coverUrl = cover("tower-of-god"),
                addedDate = offsetDays(8),
            ),
            MediaItem(
                type = MediaType.MANGA,
                title = "Frieren",
                status = MediaStatus.QUEUED,
                genre = "Fantasia, Aventura",
                coverUrl = cover("frieren"),
                addedDate = offsetDays(6),
            ),
        )

    private fun books(): List<MediaItem> =
        listOf(
            MediaItem(
                type = MediaType.BOOK,
                title = "Duna",
            ...
            MediaItem(
                ...
                currentProgress = 320,
                totalProgress = 662,
                coverUrl = cover("name-of-the-wind"),
                addedDate = offsetDays(60),
                readingStartDate = offsetDays(55),
            ),
            MediaItem(
                type = MediaType.BOOK,
                title = "Sapiens",
            ...
            MediaItem(
                ...
                currentProgress = 150,
                totalProgress = 541,
                coverUrl = cover("mistborn"),
                addedDate = offsetDays(1000),
                readingStartDate = offsetDays(20),
            ),
            MediaItem(
                type = MediaType.BOOK,
                title = "1984",
                ...
                coverUrl = cover("1984"),
                addedDate = offsetDays(1200),
                readingStartDate = offsetDays(1160),
                completionDate = offsetDays(1150),
            ),
            MediaItem(
                type = MediaType.BOOK,
                ...
                currentProgress = 200,
                totalProgress = 476,
                coverUrl = cover("hail-mary"),
                addedDate = offsetDays(20),
                readingStartDate = offsetDays(18),
            ),
            MediaItem(
                type = MediaType.BOOK,
            ...
            MediaItem(
                ...
                coverUrl = cover("fourth-wing"),
                addedDate = offsetDays(9),
            ),
            MediaItem(
                type = MediaType.BOOK,
                title = "A Metamorfose",
            ...
            MediaItem(
                ...
                currentProgress = 352,
                totalProgress = 352,
                coverUrl = cover("educated"),
                addedDate = offsetDays(400),
                readingStartDate = offsetDays(375),
                completionDate = offsetDays(370),
            ),
        )

    // ── Jogatinas fictícias (Elden Ring: duas runs; Baldur's Gate 3: run em andamento) ──
    private suspend fun seedPlaythroughs(
        repo: MediaRepository,
        gameIds: List<Pair<MediaItem, Int>>,
    ) {
        ...
        if (eldenRingId != null) {
            repo.savePlaythrough(
                eldenRingId,
                GamePlaythrough(
                    title = "Primeira zerada",
                    startDate = offsetDays(200),
                    endDate = offsetDays(140),
                    hoursPlayed = 68,
                    progressPercent = 100,
                    notes = "Build de sangramento, final padrão.",
                ),
            )
            repo.savePlaythrough(
                eldenRingId,
                GamePlaythrough(
                    title = "Run de int/fé",
                    startDate = offsetDays(120),
                    endDate = offsetDays(90),
                    hoursPlayed = 45,
                    progressPercent = 100,
                    notes = "Terminei com o final de Ranni.",
                ),
            )
            repo.savePlaythrough(
                eldenRingId,
        ...
        if (bg3Id != null) {
            repo.savePlaythrough(
                bg3Id,
                GamePlaythrough(
                    title = "Tactician — Gloomstalker/Assassin",
                    startDate = offsetDays(90),
                    endDate = null,
                    hoursPlayed = 52,
                    progressPercent = 45,
                    notes = "Ato 2, decidindo o destino da Nightsong.",
                ),
            )
            repo.savePlaythrough(
                bg3Id,
                GamePlaythrough(
                    title = "Honra (planejada)",
                    startDate = null,
                    endDate = null,
                    hoursPlayed = null,
                    progressPercent = 0,
    ...
    private suspend fun seedGameCache(gameIds: List<Pair<MediaItem, Int>>) {
        ...
        DB.cache.save(
            ...
            mapOf(
                "synopsis" to
                    "Um mundo em ruínas aguarda um novo Lorde. Explore as Terras Intermédias, enfrente semideuses e reivindique o Círculo de Elden.",
