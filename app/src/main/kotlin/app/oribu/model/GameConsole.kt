...
enum class GameConsole(
    ...
    companion object {
        fun fromDb(value: String): GameConsole? = entries.firstOrNull { it.dbValue == value }
        ...
        fun modern(): List<GameConsole> = listOf(STEAM, PC, PS5, PS4, NS2, NS, XSX, X_ONE)
    }
}
